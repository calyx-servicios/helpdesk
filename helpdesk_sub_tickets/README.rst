...
This module extends the functionality of Helpdesk to allow you to create related tickets 
...
1. Go to Create Ticket and you can add sub-tickets through the "related tickets" section 

Known issues / Roadmap
======================

* Editing sub-tickets is not allowed
* Parent tickets are manually closed
